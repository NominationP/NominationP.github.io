...
### [View alive Yibo Blog &rarr;](https://huangxuan.me)  
...
```yml
# Site settings
title: Yibo Blog             # title of your website
SEOTitle: Yibo Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Yibo Blog”** but I want the title shows in search engine is **“黄玄的博客 | Yibo Blog”** which is multi-language.
...
Yibo Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
